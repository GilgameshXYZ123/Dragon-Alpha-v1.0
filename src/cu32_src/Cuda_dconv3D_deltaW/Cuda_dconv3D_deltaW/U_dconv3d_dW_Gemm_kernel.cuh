...
//LB = log2(BLOCK_SIZE)
#define UkGemm88(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_8_8<LB, (1<<LB>>1)>\
		<<< dim3(GM>>LB>>3, GN>>LB>>3), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(X, IH, IW, deltaY, OH, OW, deltaW, FH, FW,\
			 N, IC, OC, sh, sw, ph, pw, oc_index, j_index)

#define UkGemm44(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_4_4<LB, (1<<LB>>1)>\
		<<< dim3(GM>>LB>>2, GN>>LB>>2), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(X, IH, IW, deltaY, OH, OW, deltaW, FH, FW,\
			 N, IC, OC, sh, sw, ph, pw, oc_index, j_index)

#define UkGemm42(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_4_2<LB, (1<<LB>>1)>\
		<<< dim3(GM>>LB>>1, GN>>LB>>2), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(X, IH, IW, deltaY, OH, OW, deltaW, FH, FW,\
			 N, IC, OC, sh, sw, ph, pw, oc_index, j_index)

#define UkGemm24(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_2_4<LB, (1<<LB>>1)>\
		<<< dim3(GM>>LB>>2, GN>>LB>>1), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(X, IH, IW, deltaY, OH, OW, deltaW, FH, FW,\
			 N, IC, OC, sh, sw, ph, pw, oc_index, j_index)

#define UkGemm41(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_4_1<LB, (1<<LB)>\
		<<< dim3(GM>>LB, GN>>LB>>2), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(X, IH, IW, deltaY, OH, OW, deltaW, FH, FW,\
			 N, IC, OC, sh, sw, ph, pw, oc_index, j_index)

#define UkGemm14(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_1_4<LB, (1<<LB)>\
		<<< dim3(GM>>LB>>2, GN>>LB), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(X, IH, IW, deltaY, OH, OW, deltaW, FH, FW,\
			 N, IC, OC, sh, sw, ph, pw, oc_index, j_index)

#define UkGemm22(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_2_2<LB, (1<<LB)>\
		<<< dim3(GM>>LB>>1, GN>>LB>>1), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(X, IH, IW, deltaY, OH, OW, deltaW, FH, FW,\
			N, IC, OC, sh, sw, ph, pw, oc_index, j_index)

#define UkGemm21(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_2_1<LB, (1<<LB)>\
		<<< dim3(GM>>LB, GN>>LB>>1), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(X, IH, IW, deltaY, OH, OW, deltaW, FH, FW,\
			 N, IC, OC, sh, sw, ph, pw, oc_index, j_index)

#define UkGemm12(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_1_2<LB, (1<<LB)>\
		<<< dim3(GM>>LB>>1, GN>>LB), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(X, IH, IW, deltaY, OH, OW, deltaW, FH, FW,\
			 N, IC, OC, sh, sw, ph, pw, oc_index, j_index)

#define UkGemm11(stream, LB, oc_index, j_index, X, IH, IW, deltaY, OH, OW, deltaW, FH, FW, N, IC, OC, sh, sw, ph, pw, GN, GM)\
	Ukernel_Gemm_1_1<LB, (1<<LB)>\
...
//LB=4: Size = 1, Time = 1.91 msec, Performace = 1124.34 GFlop/s
//LB=3: Size = 1, Time = 2.334 msec, Performace = 920.087 GFlop/s
template<int LB, int STEP>
__global__ void Ukernel_Gemm_8_8(
	...
	int oc_index, int j_index)
{
	...
	const int X0 = (tfh0*IW + tfw0)*IC + tic0;
	...
	Xs[buf][ty][tx].x = (lx0 ? X[X0 + xoffset] : 0);
	Xs[buf][ty][tx].y = (lx0 ? X[X1 + xoffset] : 0);
	Xs[buf][ty][tx].z = (lx0 ? X[X2 + xoffset] : 0);
	Xs[buf][ty][tx].w = (lx0 ? X[X3 + xoffset] : 0);
	__syncthreads();
...
//LB=4: Size = 1, Time = 2.754 msec, Performace = 779.769 GFlop/s
//LB=3: Size = 1, Time = 3.542 msec, Performace = 606.291 GFlop/s
template<int LB, int STEP>
__global__ void Ukernel_Gemm_4_4(
	const float* __restrict__ X, int IH, int IW,
	const float* __restrict__ deltaY, int OH, int OW,
	float* __restrict__ deltaW, int FH, int FW,
	int N, int IC, int OC,
...
template<int LB, int STEP>
__global__ void Ukernel_Gemm_4_2(
	const float* __restrict__ X, int IH, int IW,
	const float* __restrict__ deltaY, int OH, int OW,
	float* __restrict__ deltaW, int FH, int FW,
	int N, int IC, int OC,
...
//LB=4: Size = 1, Time = 4.084 msec, Performace = 525.828 GFlop/s
//LB=3: Size = 1, Time = 5.742 msec, Performace = 373.996 GFlop/s
template<int LB, int STEP>
__global__ void Ukernel_Gemm_2_4(
	const float* __restrict__ X, int IH, int IW,
	const float* __restrict__ deltaY, int OH, int OW,
	float* __restrict__ deltaW, int FH, int FW,
	int N, int IC, int OC,
...
template<int LB, int STEP>
__global__ void Ukernel_Gemm_2_2(
	const float* __restrict__ X, int IH, int IW,
	const float* __restrict__ deltaY, int OH, int OW,
	float* __restrict__ deltaW, int FH, int FW,
	int N, int IC, int OC,
...
template<int LB, int STEP>
__global__ void Ukernel_Gemm_4_1(
	const float* __restrict__ X, int IH, int IW,
	const float* __restrict__ deltaY, int OH, int OW,
	float* __restrict__ deltaW, int FH, int FW,
	int N, int IC, int OC,
...
template<int LB, int STEP>
__global__ void Ukernel_Gemm_1_4(
	const float* __restrict__ X, int IH, int IW,
	const float* __restrict__ deltaY, int OH, int OW,
	float* __restrict__ deltaW, int FH, int FW,
	int N, int IC, int OC,
...
template<int LB, int STEP>
__global__ void Ukernel_Gemm_2_1(
	const float* __restrict__ X, int IH, int IW,
	const float* __restrict__ deltaY, int OH, int OW,
	float* __restrict__ deltaW, int FH, int FW,
	int N, int IC, int OC,
...
template<int LB, int STEP>
__global__ void Ukernel_Gemm_1_2(
	const float* __restrict__ X, int IH, int IW,
	const float* __restrict__ deltaY, int OH, int OW,
	float* __restrict__ deltaW, int FH, int FW,
	int N, int IC, int OC,
...
template<int LB, int STEP>
__global__ void Ukernel_Gemm_1_1(
	const float* __restrict__ X, int IH, int IW,
	const float* __restrict__ deltaY, int OH, int OW,
	float* __restrict__ deltaW, int FH, int FW,
	int N, int IC, int OC,
