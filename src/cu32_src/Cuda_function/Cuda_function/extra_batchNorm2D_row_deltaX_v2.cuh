...
#ifndef BATCH_NORM_2D_ROW_DELTAX_V2_H
#define BATCH_NORM_2D_ROW_DELTAX_V2_H
...
//(5) affined = false
#ifndef BATCH_NORM_2D_ROW_DELTAX_V2_CALL
#define BATCH_NORM_2D_ROW_DELTAX_V2_CALL

//LB = log2(BLOCK_SIZE)
//LT = log2(THREAD_ELEMENT_VISIT_SIZE)

#define batchNorm2d_row_deltaX_v2_k4(stream, LB, LT, deltaY, X, X_mean, X_var, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)\
	batchNorm2D_row_deltaX_v2_kernel_4\
		<<< lengthv>>LB>>LT, (1<<LB), 0, stream >>>\
			(deltaY, X, X_mean, X_var, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)

#define batchNorm2d_row_deltaX_v2_k4_small(stream, deltaY, X, X_mean, X_var, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)\
	batchNorm2D_row_deltaX_v2_kernel_4\
...
#ifndef BATCH_NORM_2D_ROW_DELTAX_V2_KERNEL
#define BATCH_NORM_2D_ROW_DELTAX_V2_KERNEL
...
__global__ void batchNorm2D_row_deltaX_v2_kernel_4(
...
void __batchNorm2D_row_deltaX_v2(cudaStream_t stream,
	...
	int lengthv, int width, int stride)
{
	if (lengthv < 256) { batchNorm2d_row_deltaX_v2_k4_small(stream, deltaY, X, X_mean, X_var, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride); return; }
	batchNorm2d_row_deltaX_v2_k4(stream, 5, 2, deltaY, X, X_mean, X_var, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride);
}
