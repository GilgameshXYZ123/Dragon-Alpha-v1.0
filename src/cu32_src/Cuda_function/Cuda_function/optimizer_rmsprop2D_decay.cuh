...
#ifndef RMSPROP_2D_DECAY_H
#define RMSPROP_2D_DECAY_H

//lengthv = height * stride
//stride = (width + 3)/4*4
//[lenghtv, stride] % 4 == 0
#ifndef RMSPROP_2D_DECAY_CALL
#define RMSPROP_2D_DECAY_CALL

//LB = log2(BLOCK_SIZE)
//LT = log2(THREAD_ELEMENT_VISIT_SIZE)

#define rmsprop2d_decay_k4(stream, LB, LT, W, S, a1, a2, eps_t, deltaW, lr_t, L1coef, L2coef, lengthv, width, stride)\
	rmsprop2D_decay_kernel_4\
		<<< lengthv>>LB>>LT, (1<<LB), 0, stream >>>\
			(W, S,a1,a2,eps_t, deltaW,lr_t, L1coef, L2coef, lengthv,width,stride)

#define rmsprop2d_decay_k4_small(stream, W, S, a1, a2, eps_t, deltaW, lr_t, L1coef, L2coef, lengthv, width, stride)\
	rmsprop2D_decay_kernel_4\
...
#ifndef RMSPROP_2D_DECAY_KERNEL
#define RMSPROP_2D_DECAY_KERNEL

__global__ void rmsprop2D_decay_kernel_4(
...
void __rmsprop2D_decay(cudaStream_t stream,
	const float* W,
	...
	int lengthv, int width, int stride)
{
	if (lengthv < 256) { rmsprop2d_decay_k4_small(stream, W, S, a1, a2, eps_t, deltaW, lr_t, L1coef, L2coef, lengthv, width, stride); return; }
	rmsprop2d_decay_k4(stream, 5, 2, W, S, a1, a2, eps_t, deltaW, lr_t, L1coef, L2coef, lengthv, width, stride);
}
