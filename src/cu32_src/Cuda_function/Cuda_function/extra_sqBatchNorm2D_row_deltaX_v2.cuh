...
#ifndef SQUARE_BATCH_NORM_2D_ROW_DELTAX_V2_H
#define SQUARE_BATCH_NORM_2D_ROW_DELTAX_V2_H
...
//(5) affined = false
#ifndef SQUARE_BATCH_NORM_2D_ROW_DELTAX_V2_CALL
#define SQUARE_BATCH_NORM_2D_ROW_DELTAX_V2_CALL

//LB = log2(BLOCK_SIZE)
//LT = log2(THREAD_ELEMENT_VISIT_SIZE)

#define sqBatchNorm2d_row_deltaX_v2_k4(stream, LB, LT, deltaY, X, X_mean, X_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)\
	sqBatchNorm2D_row_deltaX_v2_kernel_4\
		<<< lengthv>>LB>>LT, (1<<LB), 0, stream >>>\
			(deltaY, X, X_mean, X_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)

#define sqBatchNorm2d_row_deltaX_v2_k4_small(stream, deltaY, X, X_mean, X_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride)\
	sqBatchNorm2D_row_deltaX_v2_kernel_4\
...
#ifndef SQUARE_BATCH_NORM_2D_ROW_DELTAX_V2_KERNEL
#define SQUARE_BATCH_NORM_2D_ROW_DELTAX_V2_KERNEL
...
__global__ void sqBatchNorm2D_row_deltaX_v2_kernel_4(
...
void __sqBatchNorm2D_row_deltaX_v2(cudaStream_t stream,
	...
	int lengthv, int width, int stride)
{
	if (lengthv < 256) { sqBatchNorm2d_row_deltaX_v2_k4_small(stream, deltaY, X, X_mean, X_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride); return; }
	sqBatchNorm2d_row_deltaX_v2_k4(stream, 5, 2, deltaY, X, X_mean, X_sqmean, eps, deltaXp1, deltaXp2, row_lengthv, deltaX, lengthv, width, stride);
}
