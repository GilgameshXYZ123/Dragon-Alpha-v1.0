...
#ifndef UNPOOL2D_AVERAGE_IGNORE_PADDING_KERNEL_H
#define UNPOOL2D_AVERAGE_IGNORE_PADDING_KERNEL_H
...
//(3) GM % 4==0, GM >= 4
//(4) GK = FH * FW >= 2
#ifndef UNPOOL_2D_AVERAGE_IGNORE_PADDING_KERNEL_CALL
#define UNPOOL_2D_AVERAGE_IGNORE_PADDING_KERNEL_CALL

#define kavg81_ip(stream, LBY, LBX, ic_index, j_index, deltaY, OH, OW, FH, FW, deltaX, IH, IW, IC, sh, sw, ph, pw, GN, GM)\
	avg_kernel_8_1_ignore_padding\
		<<< dim3(GM>>LBX, GN>>LBY>>3), dim3(1<<LBX, 1<<LBY), 0, stream >>>\
			(deltaY,OH,OW, FH, FW, deltaX,IH,IW, IC, sh,sw,ph,pw, ic_index, j_index)

#define kavg41_ip(stream, LBY, LBX, ic_index, j_index, deltaY, OH, OW, FH, FW, deltaX, IH, IW, IC, sh, sw, ph, pw, GN, GM)\
	avg_kernel_4_1_ignore_padding\
		<<< dim3(GM>>LBX, GN>>LBY>>2), dim3(1<<LBX, 1<<LBY), 0, stream >>>\
			(deltaY,OH,OW, FH, FW, deltaX,IH,IW, IC, sh,sw,ph,pw, ic_index, j_index)

#define kavg21_ip(stream, LBY, LBX, ic_index, j_index, deltaY, OH, OW, FH, FW, deltaX, IH, IW, IC, sh, sw, ph, pw, GN, GM)\
	avg_kernel_2_1_ignore_padding\
		<<< dim3(GM>>LBX, GN>>LBY>>1), dim3(1<<LBX, 1<<LBY), 0, stream >>>\
			(deltaY,OH,OW, FH, FW, deltaX,IH,IW, IC, sh,sw,ph,pw, ic_index, j_index)

#define kavg11_ip(stream, LBY, LBX, ic_index, j_index, deltaY, OH, OW, FH, FW, deltaX, IH, IW, IC, sh, sw, ph, pw, GN, GM)\
	avg_kernel_1_1_ignore_padding\
...
//(Y: BLOCK_SIZE*8)
#ifndef UNPOOL2D_AVG_IGNORE_PADDING_KERNEL_8_1
#define UNPOOL2D_AVG_IGNORE_PADDING_KERNEL_8_1
...
__global__ void avg_kernel_8_1_ignore_padding(
...
//(Y: BLOCK_SIZE*4)
#ifndef UNPOOL2D_AVG_IGNORE_PADDING_KERNEL_4_1
#define UNPOOL2D_AVG_IGNORE_PADDING_KERNEL_4_1
...
__global__ void avg_kernel_4_1_ignore_padding(
	const float* __restrict__ deltaY, int OH, int OW,
	int FH, int FW,
	float* __restrict__ deltaX, int IH, int IW,
	int IC,
...
//(Y: BLOCK_SIZE*2)
#ifndef UNPOOL2D_AVG_IGNORE_PADDING_KERNEL_2_1
#define UNPOOL2D_AVG_IGNORE_PADDING_KERNEL_2_1
...
__global__ void avg_kernel_2_1_ignore_padding(
	const float* __restrict__ deltaY, int OH, int OW,
	int FH, int FW,
	float* __restrict__ deltaX, int IH, int IW,
	int IC,
...
//(Y: BLOCK_SIZE*2)
#ifndef UNPOOL2D_AVG_IGNORE_PADDING_KERNEL_1_1
#define UNPOOL2D_AVG_IGNORE_PADDING_KERNEL_1_1
...
__global__ void avg_kernel_1_1_ignore_padding(
	const float* __restrict__ deltaY, int OH, int OW,
	int FH, int FW,
	float* __restrict__ deltaX, int IH, int IW,
	int IC,
