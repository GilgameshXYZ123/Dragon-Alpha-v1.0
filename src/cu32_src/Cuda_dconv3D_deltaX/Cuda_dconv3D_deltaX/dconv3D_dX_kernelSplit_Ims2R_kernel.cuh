...
#define ksIms2_88R8(stream, LB, ic_index, j_index, deltaY, OH, OW, CW, FH, FW, deltaX, IH_slice, IW_slice, IC, OC, ph, pw, GN, GM) \
	ksIms2_kernel_8_8R8<LB, (1<<LB>>1)>\
...
#define ksIms2_88R4(stream, LB, ic_index, j_index, deltaY, OH, OW, CW, FH, FW, deltaX, IH_slice, IW_slice, IC, OC, ph, pw, GN, GM) \
	ksIms2_kernel_8_8R4<LB, (1<<LB>>1)>\
		<<< dim3((GN>>LB>>3), (GM>>LB>>3), 4), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(deltaY, OH, OW, CW, FH, FW, CWstride, deltaX, (IH_slice*IW_slice), IW_slice, IC, OC, ph, pw,\
			ic_index, j_index)

#define ksIms2_88R(stream, LB, ic_index, j_index, deltaY, OH, OW, CW, FH, FW, deltaX, IH_slice, IW_slice, IC, OC, ph, pw, GN, GM) \
	ksIms2_kernel_8_8R<LB, (1<<LB>>1)>\
		<<< dim3((GN>>LB>>3), (GM>>LB>>3), 4), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(deltaY, OH, OW, CW, FH, FW, CWstride, deltaX, (IH_slice*IW_slice), IW_slice, IC, OC, ph, pw,\
			ic_index, j_index)

//----------------------------------------------------------------------------
#define ksIms2_84R(stream, LB, ic_index, j_index, deltaY, OH, OW, CW, FH, FW, deltaX, IH_slice, IW_slice, IC, OC, ph, pw, GN, GM) \
	ksIms2_kernel_8_4R<LB, (1<<LB>>1)>\
		<<< dim3((GN>>LB>>3), (GM>>LB>>2), 4), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(deltaY, OH, OW, CW, FH, FW, CWstride, deltaX, (IH_slice*IW_slice), IW_slice, IC, OC, ph, pw,\
			ic_index, j_index)

#define ksIms2_48R(stream, LB, ic_index, j_index, deltaY, OH, OW, CW, FH, FW, deltaX, IH_slice, IW_slice, IC, OC, ph, pw, GN, GM) \
	ksIms2_kernel_4_8R<LB, (1<<LB>>1)>\
		<<< dim3((GN>>LB>>2), (GM>>LB>>3), 4), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(deltaY, OH, OW, CW, FH, FW, CWstride, deltaX, (IH_slice*IW_slice), IW_slice, IC, OC, ph, pw,\
			ic_index, j_index)

#define ksIms2_44R(stream, LB, ic_index, j_index, deltaY, OH, OW, CW, FH, FW, deltaX, IH_slice, IW_slice, IC, OC, ph, pw, GN, GM) \
	ksIms2_kernel_4_4R<LB, (1<<LB>>1)>\
		<<< dim3((GN>>LB>>2), (GM>>LB>>2), 4), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(deltaY, OH, OW, CW, FH, FW, CWstride, deltaX, (IH_slice*IW_slice), IW_slice, IC, OC, ph, pw,\
			ic_index, j_index)

#define ksIms2_42R(stream, LB, ic_index, j_index, deltaY, OH, OW, CW, FH, FW, deltaX, IH_slice, IW_slice, IC, OC, ph, pw, GN, GM) \
	ksIms2_kernel_4_2R<LB, (1<<LB>>1)>\
		<<< dim3((GN>>LB>>2), (GM>>LB>>1), 4), dim3(1<<LB, 1<<LB), 0, stream >>>\
			(deltaY, OH, OW, CW, FH, FW, CWstride, deltaX, (IH_slice*IW_slice), IW_slice, IC, OC, ph, pw,\
			ic_index, j_index)

#define ksIms2_24R(stream, LB, ic_index, j_index, deltaY, OH, OW, CW, FH, FW, deltaX, IH_slice, IW_slice, IC, OC, ph, pw, GN, GM) \
	ksIms2_kernel_2_4R<LB, (1<<LB>>1)>\
...
//LB = 3: Size = 1.125, Time = 0.606 msec, Performace = 3986.67 GFlop/s
//LB = 4: Size = 1.125, Time = 0.508 msec, Performace = 4755.75 GFlop/s(1000)
//LB = 3: Size = 1.125, Time = 0.568 msec, Performace = 4253.38 GFlop/s(1000)
template<int LB, int STEP>
__global__ void ksIms2_kernel_8_8R8(
...
//LB = 4: Size = 1.53125, Time = 0.7 msec, Performace = 4697.62 GFlop/s
//LB = 4: Size = 1.125, Time = 0.542 msec, Performace = 4457.42 GFlop/s
//LB = 3: Size = 1.125, Time = 0.608 msec, Performace = 3973.55 GFlop/s
template<int LB, int STEP>
__global__ void ksIms2_kernel_8_8R4(
	const float* __restrict__ deltaY, int OH, int OW,
	const float* __restrict__ CW, int FH, int FW, int CWstride,
	float* __restrict__ deltaX, int IH_IW_slice, int IW_slice,
	int IC, int OC,
...
//LB = 3: Size = 1.125, Time = 0.624 msec, Performace = 3871.67 GFlop/s
template<int LB, int STEP>
__global__ void ksIms2_kernel_8_8R(
	const float* __restrict__ deltaY, int OH, int OW,
	const float* __restrict__ CW, int FH, int FW, int CWstride,
	float* __restrict__ deltaX, int IH_IW_slice, int IW_slice,
	int IC, int OC,
...
template<int LB, int STEP>
__global__ void ksIms2_kernel_8_4R(
	const float* __restrict__ deltaY, int OH, int OW,
	const float* __restrict__ CW, int FH, int FW, int CWstride,
	float* __restrict__ deltaX, int IH_IW_slice, int IW_slice,
	int IC, int OC,
...
template<int LB, int STEP>
__global__ void ksIms2_kernel_4_8R(
	const float* __restrict__ deltaY, int OH, int OW,
	const float* __restrict__ CW, int FH, int FW, int CWstride,
	float* __restrict__ deltaX, int IH_IW_slice, int IW_slice,
	int IC, int OC,
...
template<int LB, int STEP>
__global__ void ksIms2_kernel_4_4R(
	const float* __restrict__ deltaY, int OH, int OW,
	const float* __restrict__ CW, int FH, int FW, int CWstride,
	float* __restrict__ deltaX, int IH_IW_slice, int IW_slice,
	int IC, int OC,
...
template<int LB, int STEP>
__global__ void ksIms2_kernel_4_2R(
	const float* __restrict__ deltaY, int OH, int OW,
	const float* __restrict__ CW, int FH, int FW, int CWstride,
	float* __restrict__ deltaX, int IH_IW_slice, int IW_slice,
	int IC, int OC,
...
template<int LB, int STEP>
__global__ void ksIms2_kernel_2_4R(
	const float* __restrict__ deltaY, int OH, int OW,
	const float* __restrict__ CW, int FH, int FW, int CWstride,
	float* __restrict__ deltaX, int IH_IW_slice, int IW_slice,
	int IC, int OC,
