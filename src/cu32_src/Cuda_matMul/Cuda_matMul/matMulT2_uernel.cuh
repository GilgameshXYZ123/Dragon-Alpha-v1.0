...
//LB = 4: Size = 1, Time = 1.35  msec, Performace = 1590.73 GFlop/s(1000)
//LB = 3: Size = 1, Time = 1.689 msec, Performace = 1271.45 GFlop/s(1000)
	...
	int SC, int K)
{
	...
	Bs[buf][(ty << 1)][tx] = make_float4(b0.x, b1.x, b2.x, b3.x);
	Bs[buf][(ty << 1) + 1][tx] = make_float4(b0.y, b1.y, b2.y, b3.y);

	A += STEP2; B += STEP2;//K += STEP
	__syncthreads();
...
//LB = 4: Size = 1, Time = 1.565 msec, Performace = 1372.19 GFlop/s(1000)
//LB = 3: Size = 1, Time = 2.36  msec, Performace = 909.951 GFlop/s(1000)
template<int LB, int STEP, int STEP2>
...
//LB = 4: Size = 1, Time = 1.73  msec, Performace = 1241.32 GFlop/s(1000)
//LB = 3: Size = 1, Time = 2.017 msec, Performace = 1064.69 GFlop/s(1000)
template<int LB, int STEP, int STEP2>
