...
public class Sqrt extends SimpleInplaceFunction<Sqrt>
{
    protected float alpha;
    protected float beta;
    
    public Sqrt(boolean inplace, float alpha, float beta) {
        super(inplace);
        this.alpha = alpha;
        this.beta = beta;
    }
    ...
    public Sqrt alpha(float alpha) { this.alpha = alpha; return this; }
    
    public float beta() { return beta; }
    public Sqrt beta(float beta) { this.beta = beta; return this; }
