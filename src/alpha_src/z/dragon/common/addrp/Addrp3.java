...
public class Addrp3 implements Addrpool
{
    ...
    private int size = 0;
    protected final TreeMap<Long   , LinkedList_int64> int64 = new TreeMap<>();
    protected final TreeMap<Integer, LinkedList_int64> int32 = new TreeMap<>();
    ...
    public void append(StringBuilder sb) {
        ...
        int32.forEach((Integer block_size, LinkedList_int64 block_list)->{
    ...
    public long[] remove_max() 
    {
        ...
        {
            final Entry<Integer, LinkedList_int64> block_int32 = int32.lastEntry();
        ...
        {
            final Entry<Long, LinkedList_int64> block_int64 = int64.lastEntry();
    ...
    public long[] remove_ceiling(long min_mem_size)//mem_size >= min_mem_size
    {
        ...
        if(min_mem_size > max_mem_size_int32) 
        {
            ...
            final Entry<Long, LinkedList_int64> block_int64 = int64.ceilingEntry(mem_size_int64);
            if(block_int64 == null) return null;
        ...
        {
            final Entry<Integer, LinkedList_int64> block_int32 = int32.ceilingEntry((int)min_mem_size);
            if(block_int32 != null) {
                block_size = block_int32.getKey(); 
                block_address = (block_list = block_int32.getValue()).remove();
                if(block_list.isEmpty()) int32.remove((int)block_size);
            ...
            final Entry<Long, LinkedList_int64> block_int64 = int64.ceilingEntry(min_mem_size);
            if(block_int64 == null) return null;
    ...
    public long[] remove_floor(long max_mem_size)//mem_size <= min_mem_size
    {
        ...
        {
            final Entry<Integer, LinkedList_int64> block_int32 = int32.floorEntry((int)max_mem_size);
            if(block_int32 == null) return null;
        ...
        else for(;;)//max_mem_size > max_memsize_int32
        {
            ...
            final Entry<Long, LinkedList_int64> block_int64 = int64.floorEntry(max_mem_size);
            if(block_int64 == null) return null;
    ...
    {   
        ...
        {
            Entry<Integer, LinkedList_int64> block_int32 = int32.ceilingEntry((int)min_mem_size);
            if(block_int32 != null) {
                if((block_size = block_int32.getKey()) > max_mem_size) return null;
            ...
            Entry<Long, LinkedList_int64> block_int64 = int64.ceilingEntry(min_mem_size);
            if(block_int64 == null) return null;
