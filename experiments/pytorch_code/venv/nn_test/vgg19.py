...
class VGG19(nn.Module):
    def __init__(self):
        ...
        self.conv15 = nn.Conv2d(512, 512, 3, 1, 1, bias=False);
        self.conv16 = nn.Conv2d(512, 512, 3, 1, 1, bias=False);
    ...
    def forward(self, X):
        ...
        X = F.leaky_relu(self.conv14(X), inplace=True);
...
class config(object):
    ...
    weight = "C:\\Users\\Gilgamesh\\Desktop\\torch_cifar10_vgg19.pt";
