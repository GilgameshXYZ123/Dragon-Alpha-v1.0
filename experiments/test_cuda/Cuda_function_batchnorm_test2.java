 ...
 * @author Gilgamesh
 */
public class Cuda_function_batchnorm_test2 
{
	...
	int lengthv = height * 2 * 3 * stride;
        ...
        Matrix.batchNorm_deltaX2(mdeltaY, mX, X_mean, X_square_mean, eps, mdeltaX, height, 2 * 3 * width);
        
        //GPU-------------------------------------------------------------------
        Tensor tY = eg.sqBatchNorm(false, tX, tX_mean, tX_square_mean, eps).c();
        Tensor tdeltaX1 = eg.sqBatchNorm_deltaX_v1(false, tdeltaY, tY, tX_mean, tX_square_mean, eps).c();
        Tensor tdeltaX2 = eg.sqBatchNorm_deltaX_v2(false, tdeltaY, tX, tX_mean, tX_square_mean, eps).c();
