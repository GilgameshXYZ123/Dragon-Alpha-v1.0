 ...
 * @author Gilgamesh
 */
public class Cuda_function_layernorm_test3 
{
...
//        A = Vector.ones(2 * 3 * width);
//        B = Vector.zeros(2 * 3 * width);
        ...
        Matrix.layerNorm_deltaX1(mdeltaY, mX, X_mean, X_square_mean, eps, A, mdeltaX, height, 2 * 3 * width);
        
        //GPU-------------------------------------------------------------------
        Tensor tY = eg.layerNorm(false, tX, tX_mean, tX_square_mean, eps, tA, tB).c();
        Tensor tdeltaX1 = eg.layerNorm_deltaX_v1(false, tdeltaY, tY, tX_mean, tX_square_mean, eps, tA, tB).c();
        Tensor tdeltaX2 = eg.layerNorm_deltaX_v2(false, tdeltaY, tX, tX_mean, tX_square_mean, eps, tA).c();
